    ...
    fn new() -> Self {
        let rooms = vec![
            Room::new(
                ...
                RoomContent::Monster(Arc::new(Mutex::new(Monster::new("Goblin", 30, 5)))),
            ),
            ...
            Room::new(
                ...
                RoomContent::Monster(Arc::new(Mutex::new(Monster::new("Dragon", 100, 20)))),
            ),
        ];
    ...
    while player.is_alive() {
        ...
        match &room.contents {
            RoomContent::Monster(monster_rc) => {
                let mut monster = monster_rc.lock().unwrap();
